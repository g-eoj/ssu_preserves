...
By default, this script will log summaries to ./tmp/retrain_updated_augment_logs directory

Visualize the summaries with this command:

tensorboard --logdir ./tmp/retrain_updated_augment_logs
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='./tmp/output_updated_augment_graph.pb',
        help='Where to save the trained graph.'
    )
    parser.add_argument(
        '--intermediate_output_graphs_dir',
        type=str,
        default='./tmp/intermediate_updated_augment_graph/',
    ...
    parser.add_argument(
        '--output_labels',
        type=str,
        default='./tmp/output_updated_augment_labels.txt',
        help='Where to save the trained graph\'s labels.'
    )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='./tmp/retrain_updated_augment_logs',
