...
tf.app.flags.DEFINE_string('image_dir', './test_images/',
                           """Path to folders of labeled images.""")
'''
tf.app.flags.DEFINE_string('output_graph', model,
                           """Where to save the trained graph.""")
'''
tf.app.flags.DEFINE_string('output_labels', labels,
                           """Where to save the trained graph's labels.""")
tf.app.flags.DEFINE_string('summaries_dir', './tmp/test_logs',
...
tf.app.flags.DEFINE_integer('train_batch_size', 800,
...
def create_inception_graph():
  ...
  with tf.Session() as sess:
    model_filename = os.path.join(
        FLAGS.model_dir, 'output_graph.pb')
...
def main(_):
  ...
  test_bottlenecks, test_ground_truth = get_random_cached_bottlenecks(
      ...
      bottleneck_tensor)
  print(test_bottlenecks[0:3])
  print(test_ground_truth[0:3])
